...
one_ab_permutation = function(n_yes, n_no, n_a, 
                              verbose=FALSE, max_print=20) {
  # Input (parameters):
  # - n_yes: Total (A + B) number of successes (1, yes)
  # - n_no : Total (A + B) number of failures  (0, no)
  # - n_a  : Number of individuals in group A
  #
  # Output (result):
  # - ab_yes_pct_diff
...
n_ab_permutations = function(n_yes, n_no, n_a, n_p, 
                             verbose=FALSE, max_print=100) {
  # Input (parameters):
  # - n_yes: Total (A + B) number of successes (1, yes)
  # - n_no : Total (A + B) number of failures  (0, no)
  # - n_a  : Number of individuals in group A
...
ab_permutation_test = function(a_all, b_all, a_yes, b_yes, n_p=100,
  ...
  polygon(c(-xc, d$x[c2], xc), c(0, d$y[c2], 0), col='skyblue')
